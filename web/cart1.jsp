...
<html lang="en">
    ...
    <body>
            ...
            <section class="payment">
                <div class="payment-container">
                    ...
                    <div class="right-payment">
                        ...
                        <a href="GundamController/view" target="_blank" class="checkout-btn"><button class="item__button btn-color ">Checkout</button></a>
        ...
        <script src="<c:url value="../front-end/script.js"/>"></script>
    </body>
</html>